...
library_recommendations_assistant = Assistant(
    ...
    instructions=[f"I need a code snippet for {insert_functionality_or_task}. Can you generate a sample code snippet?"]
)
# -*- Print a response to the cli
library_recommendations_assistant.print_response(f"please help the best you can me with this functionality:{insert_functionality_or_task}, "
                                                         f"provide me the best sample you can using this technology or concept: {insert_functionality_or_task}.", markdown=True)
