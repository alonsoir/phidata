...
code_review_assistant = Assistant(
    ...
    instructions=[
        f"I’ve written a new feature. Can you review my code and provide feedback on potential improvements? Here is the code : {insert_code_here}"
    ],
)
# -*- Print a response to the cli
code_review_assistant.print_response(
    f"please help the best you can me with this code:{insert_code_here}, "
    f"provide me the best and honest peer review you can provide.",
    markdown=True,
)
