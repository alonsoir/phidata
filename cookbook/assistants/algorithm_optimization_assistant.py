...
design_patterns_recommendations_assistant = Assistant(
    ...
    instructions=[
        f"I’m implementing the algorithm named {algorithm_name}. Are there any optimization techniques or best practices I should consider?"
    ],
)
# -*- Print a response to the cli
design_patterns_recommendations_assistant.print_response(
    f"please help the best you can me with :{algorithm_name}, provide me the best sample you can.",
    markdown=True,
)
