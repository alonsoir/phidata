...
design_patterns_recommendations_assistant = Assistant(
    ...
    instructions=[f"I’m designing a new software component. These are the requirements: {requirements}. "
                  f"\nWhat design pattern would you recommend for implementing {functionality}"],
)
# -*- Print a response to the cli
design_patterns_recommendations_assistant.print_response(f"these are my requirements:{requirements} \n and this is the functionality: {functionality} i expect", markdown=True)
