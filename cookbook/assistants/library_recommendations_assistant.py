...
library_recommendations_assistant = Assistant(
    ...
    instructions=[
        f"I’m starting a new project. Can you recommend a suitable {insert_programming_language} library or framework for {insert_functionality}"
    ],
)
# -*- Print a response to the cli
library_recommendations_assistant.print_response(
    f"please help the best you can me with this functionality :{insert_functionality}, "
    f"provide me the best sample you can using this language {insert_programming_language}.",
    markdown=True,
)
