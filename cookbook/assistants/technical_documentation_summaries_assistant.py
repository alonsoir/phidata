...
library_recommendations_assistant = Assistant(
    ...
    instructions=[
        f"I need a summary of the [insert technology or concept] technical documentation. Can you provide a concise overview?"
    ],
)
# -*- Print a response to the cli
library_recommendations_assistant.print_response(
    f"please help the best you can me with this functionality:{insert_technology_or_concept}, "
    f"provide me the best sample you can using this technology or concept: {insert_technology_or_concept}.",
    markdown=True,
)
