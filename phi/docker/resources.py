...
class DockerResources(InfraResources):
    ...
    def create_resources(
        ...
        from phi.docker.resource.types import (
            DockerContainer,
        ...
        resources_to_create.sort(
            key=lambda x: DockerResourceInstallOrder.get(x.__class__.__name__, 5000)
        )
